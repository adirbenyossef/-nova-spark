import { EventLoopCollector } from './EventLoopCollector';
import { Config } from './../core/Config';

describe('EventLoopCollector', () => {
  let collector: EventLoopCollector;
  let config: Config;

  beforeEach(() => {
    config = new Config({ eventLoopThreshold: 100 });
    collector = new EventLoopCollector(config);
  });
