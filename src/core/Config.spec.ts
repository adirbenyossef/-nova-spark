...
describe('Config', () => {
  ...
  it('should prevent modification of config properties', () => {
    ...
    expect(() => {
      (config as any).sampleInterval = 1000;
